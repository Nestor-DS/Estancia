...
<div class="page-container row"> 
  ...
  <div class="page-content"> 
    ...
    <div id="portlet-config" class="modal hide">
      ...
      <div class="modal-body"> Configuraciones </div>
    </div>
    ...
    <div class="content">                           
     <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Detalles de cita </a></li>                    
    </ul>
      			...
      			<div class="row">
					<div class="col-md-12">
							...
							<div class="grid-title no-border">
								<h4>Cuota de <?php echo $row['name'];?> <span class="semi-bold">Detalles</span></h4>
								<div class="tools">
