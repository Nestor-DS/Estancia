...
<div class="page-container row-fluid">	
  ...
  <a href="#" class="scrollup">Desplasarse</a>
    ...
    <div class="content">  
		<div class="page-title">
         <?php $rt=mysqli_query($con,"select * from user where id='".$_GET['id']."'");
			  ...
			  {?>	
			<h3>Perfil de <?php echo $rw['name'];?></h3>	
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="42">
                          <button type="submit" name="update" class="btn btn-primary">Guardar Configuración</button></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
