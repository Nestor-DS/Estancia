...
<body class="">
  ...
  <div class="page-content">
    <div id="portlet-config" class="modal hide">
      ...
      <div class="modal-body"> Formulario de Configuraciones </div>
    </div>
    <div class="clearfix"></div>
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Ver citas</a></li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Soporte de citas</h3>
      </div>
      <div class="clearfix"></div>

      <h4> <span class="semi-bold">Citas</span></h4>
      <br>
          ...
          <div class="col-md-12">
            <div class="grid simple no-border">
              <div class="grid-title no-border descriptive clickable">
                ...
                <p><span class="text-success bold">Cita #
                    <?php echo $_SESSION['sid'] = $row['ticket_id']; ?>
                  </span> - Creado el
                  <?php echo $row['posting_date']; ?>

                  <span class="label <?php echo ($row['status'] == 'open') ? 'label-success' : 'label-important'; ?>">
                    <?php echo ($row['status'] == 'open') ? 'Pendiente' : 'Cerrar'; ?>
                  </span>
