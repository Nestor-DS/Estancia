...
<body class="">
	...
	<div class="page-content">
		...
		<div id="portlet-config" class="modal hide">
			...
			<div class="modal-body">Configuración </div>
		</div>
		<div class="clearfix"></div>
						...
						<div class="tiles-body">
							...
							<div class="widget-stats">
								<div class="wrapper transparent">
									...
									?>
									<span class="item-title">Visitantes</span> <span
							...
							<div class="widget-stats ">
								<div class="wrapper last">
									...
									<span class="item-title">Días</span> <span
						...
						<div class="tiles-body">
							...
							<div class="widget-stats">
								<div class="wrapper transparent">
									...
									<span class="item-title">Usuarios</span> <span
						...
						<div class="tiles-body">
							...
							<div class="widget-stats">
								<div class="wrapper transparent">
									...
									?>
									<span class="item-title">Solicitudes</span> <span
							...
							<div class="widget-stats">
								<div class="wrapper transparent">
									...
									?>
									<span class="item-title">Nuevas</span> <span
							...
							<div class="widget-stats ">
								<div class="wrapper last">
									...
									?>
									<span class="item-title">En progreso</span> <span
					...
					<div class="col-md-3 col-vlg-3 col-sm-6">
						<div class="tiles red m-b-10">
							<div class="tiles-body">
								...
								<div class="tiles-title text-black">Citas</div>
								<div class="widget-stats">
									<div class="wrapper transparent">
										<?php $vt = mysqli_query($con, "select * from ticket");
										$ovt = mysqli_num_rows($vt);
										?>
										<span class="item-title">Citas</span> <span
								...
								<div class="widget-stats ">
									<div class="wrapper last">
										...
										?>
										<span class="item-title">Pendientes</span> <span
			...
			<div class="col-lg-12" style="min-height:280px;">
				<div class="panel panel-red">
					<div class="panel-heading">
						<h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Visitas de usuarios</h3>
