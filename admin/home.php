...
<div class="page-container row"> 
  ...
  <div class="page-content">
    ...
    <div id="portlet-config" class="modal hide">
      ...
      <div class="modal-body"> Formulario de configuración </div>
    </div>
    <div class="clearfix"></div>
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title text-black">Visitantes</div>
			         <div class="widget-stats">
					  ...
					  ?>
						<span class="item-title">Visitantes</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $num;?>" data-animation-duration="700">0</span>
					  </div>
                    </div>
                    <div class="widget-stats ">
					  ...
					  ?>
						...
						<span class="item-title">Días</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $num11;?>" data-animation-duration="700">0</span> <?php									
                ...
                <div class="tiles-title text-black">Usuarios</div>
			         <div class="widget-stats">
					  ...
					  $rw=mysqli_num_rows($rt);?> 
						<span class="item-title">Usuarios</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $rw;?>" data-     animation-duration="700">0</span>
					  </div>
                    </div>
                    <div class="widget-stats ">
                      <div class="wrapper last"> 
					  ...
					  $rw1=mysqli_num_rows($rt1);?>
						<span class="item-title">Días</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $rw1;?>" data-animation-duration="700">0</span> 
					 </div>
                    </div>
			  </div>			
			</div>	
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title text-black">Presupuestos </div>
			         <div class="widget-stats">
					  ...
					  ?>
						<span class="item-title">Solicitudes</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $oq?>" data-animation-duration="700">0</span>
					  </div>
                    </div>
                    <div class="widget-stats">
                      <div class="wrapper transparent">
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title text-black">Tickets</div>
			         <div class="widget-stats">
					  ...
					  ?>
						<span class="item-title">Tickets</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $ovt;?>" data-animation-duration="700">0</span>
					  </div>
                    </div>
                    ...
                    <div class="col-lg-12" style="min-height:280px;">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Visitas de los usuarios</h3>
								...
								$('#container').highcharts({
									title: {
										text: 'Grafico de visitantes de ' + n,
										x: -20 //center
									},
									subtitle: {
										text: '',
