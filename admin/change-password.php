...
if (isset($_POST['change'])) {
  ...
  if ($num > 0) {
    ...
    $_SESSION['msg1'] = "La contraseña antigua con coincide !!";
  }
}
?>
  ...
  <script language="javascript" type="text/javascript">
    ...
    function valid() {
      if (document.form1.oldpass.value == "") {
        ...
        alert(" Campo de nueva contraseña vacío !!");
        document.form1.newpass.focus();
        return false;
      }
      else if (document.form1.confirmpassword.value == "") {
        alert(" Campo de confirmación de contraseña vacío !!");
        document.form1.confirmpassword.focus();
        return false;
      }
      else if (document.form1.newpass.value.length < 6) {
        alert(" La contraseña tiene que tener al menos 6 digitos !!");
        document.form1.newpass.focus();
        return false;
      }
