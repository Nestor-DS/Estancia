...
if($a)
{
echo "<script>alert('Su perfil se actualizó con éxito.');</script>";
}
}
...
<meta charset="utf-8" />
<title>CRM | Perfil Usuario</title>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                   ...
                                   <div class="form-group">
									   ...
									   <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Correo electrónico alternativo </label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
									   ...
									   <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">No. de contacto </label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
