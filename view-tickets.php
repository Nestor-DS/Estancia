...
<meta charset="utf-8" />
<title>Usuario | Soporte de Nota</title>
...
<div class="page-container row"> 
  ...
  <div class="page-content">
    ...
    <div class="content">
      ...
      <h4> <span class="semi-bold">Notas</span></h4>
      <br>
        ...
        <div class="col-md-12">
          <div class="grid simple no-border">
            <div class="grid-title no-border descriptive clickable">
              ...
              <p ><span class="text-success bold">Nota #<?php echo $row['ticket_id'];?></span> - Creada el <?php echo $row['posting_date'];?>
            ...
            <div class="grid-body  no-border" style="display:none">
              ...
              <div class="form-actions">
                <div class="post col-md-12">
                  ...
                  <div class="info-wrapper">
                      ...
                      <hr>
                      <p class="small-text">Publicado el <?php echo $row['admin_remark_date'];?></p>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="clearfix"></div>
              ...
              <?php endif;?>
               ...
               <?php } } else {?>
<h3 align="center" style="color:red;">No se encontró ningún registro</h3>
<?php } ?>                
          </div>
        </div>
          </div>
