 <!-- BEGIN SIDEBAR -->
  <div class="page-sidebar" id="main-menu">
    ...
    <ul>	
      <li class="start"> <a href="dashboard.php"> <i class="icon-custom-home"></i> <span class="title">Inicio</span> <span class="selected"></span>  </a> 
		    </li>
          ...
          <li><a href="change-password.php"><span class="fa fa-file-text-o"> </span> Cambiar Contraseña</a> </li>
                            <li><a href="profile.php"><span class="fa fa-user"> </span> Perfil</a> </li>
                              ...
                              <li ><a href="get-quote.php"> <span class="fa fa-tasks"> </span> Solicitar Cotización</a> </li>
							     <li ><a href="create-ticket.php"><span class="fa fa-ticket"> </span> Crear Nota</a> </li>
                                <li ><a href="view-tickets.php"><span class="fa fa-ticket"> </span> Ver Nota</a> </li>
